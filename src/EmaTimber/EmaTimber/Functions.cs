...
namespace RawLambLib
{
    ...
    {
        public List<RawLamb.Log> Logs;
        public List<GluLamb.Glulam> Glulams;

        public Dictionary<RawLamb.Board, HashSet<Lamella>> BoardMatches;
        public Dictionary<Lamella, HashSet<RawLamb.Board>> LamellaMatches;
        ...
        public SortingHat()
        {
            Logs = new List<RawLamb.Log>();
            Glulams = new List<GluLamb.Glulam>();
        }

        public void AddBoards(IEnumerable<RawLamb.Board> boards)
        {
        ...
        public void AddLamellas(IEnumerable<Lamella> lamellas)
        {
            foreach (var lam in lamellas)
                LamellaMatches.Add(lam, new HashSet<RawLamb.Board>());
        }
